                ...
                <div class="modal-body">
                   ...
                   <div class="contenido">
                        <div class="contenido-izq">
                            ...
                            <div class="botones">
                               <a class="boton_amateur" onClick="amateur()"><?php echo get_field("boton_amateur")["title"];?></a>
                               <a class="boton_profesional" onClick="profesional()"><?php echo get_field("boton_profesional")["title"];?></a>
                            </div>
